...
namespace onboardDetector{
    ...
    private:
        ...
        bool pointCloudWorldFrame_ = false;
        ...
        Eigen::Vector3d maxDynamicBBoxSize_ {3.0, 3.0, 3.0};
    ...
    public:
        ...
        // callback
        void pointCloudPoseCB(const sensor_msgs::PointCloud2ConstPtr& cloud, const geometry_msgs::PoseStampedConstPtr& pose);
        void pointCloudOdomCB(const sensor_msgs::PointCloud2ConstPtr& cloud, const nav_msgs::OdometryConstPtr& odom);
        ...
        void getSensorPose(const geometry_msgs::PoseStampedConstPtr& pose, const Eigen::Matrix4d& bodyToSensor, Eigen::Matrix4d& sensorPoseMatrix);
        void getSensorPose(const nav_msgs::OdometryConstPtr& odom, const Eigen::Matrix4d& bodyToSensor, Eigen::Matrix4d& sensorPoseMatrix);
    ...
    inline void dynamicDetector::getSensorPose(const geometry_msgs::PoseStampedConstPtr& pose, const Eigen::Matrix4d& bodyToSensor, Eigen::Matrix4d& sensorPoseMatrix){
        ...
        sensorPoseMatrix = map2body * bodyToSensor;
    }

    inline void dynamicDetector::getSensorPose(const nav_msgs::OdometryConstPtr& odom, const Eigen::Matrix4d& bodyToSensor, Eigen::Matrix4d& sensorPoseMatrix){
        Eigen::Quaterniond quat;
    ...
    inline void dynamicDetector::getCameraPose(const geometry_msgs::PoseStampedConstPtr& pose, Eigen::Matrix4d& camPoseMatrix, Eigen::Matrix4d& camPoseColorMatrix){
        this->getSensorPose(pose, this->body2Cam_, camPoseMatrix);
    ...
    inline void dynamicDetector::getCameraPose(const nav_msgs::OdometryConstPtr& odom, Eigen::Matrix4d& camPoseMatrix, Eigen::Matrix4d& camPoseColorMatrix){
        this->getSensorPose(odom, this->body2Cam_, camPoseMatrix);
